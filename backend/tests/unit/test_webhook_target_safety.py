...
# The literal-credential checks moved to test_workspace_secrets.py when they
# became errors: a pasted token now blocks the save because {{secrets.NAME}}
# gives the author somewhere else to put it.
