...
from gitraki.models.analytics import ExportJob
...
DEFAULT_EXPORT_DIR = Path(tempfile.gettempdir()) / "gitraki_exports"
...
class ExportService:
    ...
    async def _export_pdf(self, job: ExportJob, data: dict) -> str:
        ...
        # Title
        title = data.get("title", data.get("report_name", "Gitraki Export"))
