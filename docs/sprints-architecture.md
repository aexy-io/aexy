# Sprints & planning — architecture

How the module is built. For how it is *used* — running a sprint, the board,
estimating, the retro — see [Sprints & planning](./sprints.md).
