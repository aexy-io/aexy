# Booking Module — architecture & setup

Provider setup, endpoints and tables. For how it is *used* — meeting types,
availability, team assignment, the public link — see [Booking](./booking.md).
