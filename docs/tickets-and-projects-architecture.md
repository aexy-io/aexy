# Tickets, projects & tasks — architecture

How the work-item modules are built. For how they are *used* — raising a
ticket, where the queue lives, turning one into work — see
[Tickets & projects](./tickets-and-projects.md).
...
| Route | Purpose |
|---|---|
| `/tickets` | **Redirect to `/dashboard`.** The queue is the My Work widget's `tickets` source; this route is kept because it is linked and bookmarked in a dozen places |
