"""API client for communicating with Gitraki backend."""
...
SERVICE_NAME = "gitraki-cli"
DEFAULT_BASE_URL = "http://localhost:8000/api"


class GitrakiClient:
    """HTTP client for Gitraki API."""

    def __init__(self, base_url: str | None = None, token: str | None = None):
        self.base_url = base_url or os.environ.get("GITRAKI_API_URL", DEFAULT_BASE_URL)
    ...
    def _get_stored_token(self) -> str | None:
        ...
        try:
            ...
            return os.environ.get("GITRAKI_API_TOKEN")
