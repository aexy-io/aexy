# People: reviews, hiring & learning — architecture

How the three modules are built. For how they are *used* — running a review
cycle, goals, assessments, learning paths — see
[Reviews, hiring & learning](./reviews-and-people.md).
